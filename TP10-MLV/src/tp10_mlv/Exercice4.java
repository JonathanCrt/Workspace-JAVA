   ...
   public static long count (List<String> lst, String pattern) {
	...
	public static void main(String[] args) {
		 ...
		 *  result 9952
			...
			ce qui est normal car on effectue davantage de comparaisons d'égalité soit O(n).	
			Le temps de la méthode count3() est légerement supérieure à celui de la méthode count2(), ce qui eput s'expliquer 
			par l'appel de plus de méthodes(on sollicite davantage la VM à l'éxécution-- phase RUNTIME), comme mapToInt() et reduce.			
		 * */
		List<String> list2 =
			      new Random(0)
